    ...
    return (
      <div className="container">
        ...
        <h2 className="subtitle">
          ...
          另外一个经理让我帮我管理下公司机房，
          我明确和他说了，．我只做 {this.state.illness} 相关的
          ， <input onChange={this.handleCompetitionChange} className="illinput" type="text" placeholder=" Windows "/>相关的服务我不管，结果这几天这个
          经理非让我调研 vsphere 的 HA ，尼玛我从心里就极度反感，跟经理说了，我不了解啊，经理来了句你学啊，
          这几天都懒得搞，随便看点文章，实验也不想做了．反正就是不想搞{this.state.competition}那套．请问我这是得了{this.state.illness}病了吗?
        </h2>
      </div>
    )
  }
